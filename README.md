...
| Mode | SW[4:0] | 7-Segment 표시 | LED[1:0] | PC 명령 |
|------|---------|--------------|---------|--------|
| Stopwatch | `2'b00` | HH.MM / SS.CC | `2'b00` | R / N / C |
| Clock | `2'b01` | HH.MM / SS.CC | `2'b01` | R / N / C |
| Time-set | (SW[3:2]) | HH.MM / SS.CC | 선택 자리 표시 | R / N / C |
| SR04 | `2'b10` | Sr04 / xxx.x cm | `2'b10` | T |
| DHT11 | `2'b11` | txx.x / hxx.x | `2'b11` | H |
| PC Control | — | — | LED[5] = 1 | M / 0~3 |
