...
|:---:|------|--------------|:---:|------|
| `00` | Stopwatch | HH:MM / SS:CC  (최대 99:59 / 59:99) | `00` | R / N / C |
| `01` | Clock | HH:MM / SS:CC  (24시간제) | `01` | R / N / C |
| `01` + SW[3] | Time-set | HH:MM / SS:CC  (선택 자리 LED 점등) | 선택 자리 | R / N / C |
| `10` | SR04 | `Sr04` / `xxx.x` (0.1 cm 단위) | `10` | T |
| `11` | DHT11 | `hxx.x` / `txx.x` (습도 / 온도) | `11` | H |
...
| Switch | 기능 |
|--------|------|
| SW[1] & SW[4] | 동작 모드 선택 (`00` Stopwatch / `01` Clock / `10` SR04 / `11` DHT11) |
